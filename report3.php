...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Call the GenerateCategoryGrantsReport stored procedure with the selected report type
        $stmt = $conn->prepare("EXEC GenerateCategoryGrantsReport 
...
<head>
    ...
    <title>Report 3 | EV Manager</title>
...
<div class="container">
    ...
    <form method="POST">
        ...
        <select name="report_type" id="report_type" required>
            ...
            <option value="1" <?= $reportType == 1 ? 'selected' : '' ?>>Report 1: Average Grant per Category</option>
            <option value="2" <?= $reportType == 2 ? 'selected' : '' ?>>Report 2: Highest and Lowest Total Grants</option>
        </select>
                    ...
                    <?php foreach ($applications as $application): ?>
                        <tr>
                            <?php if ($reportType == 1): ?>
                                ...
                                <td><?= htmlspecialchars($application['Average Grant']) ?></td>
                            <?php elseif ($reportType == 2): ?>
                                <td><?= htmlspecialchars($application['Grant Type']) ?></td>
                                <td><?= htmlspecialchars($application['Category']) ?></td>
                                <td><?= htmlspecialchars($application['Total Grants']) ?></td>
                            <?php endif; ?>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
